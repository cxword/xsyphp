...
class Caches
{
    ...
    {
    	        $this->cache_dir = $_cacheConfig['cache_dir'];
                $this->cache_prefix = $_cacheConfig['cache_prefix'];
                $this->cache_time = $_cacheConfig['cache_time'];
                $this->cache_mode = $_cacheConfig['cache_mod'];
    }
